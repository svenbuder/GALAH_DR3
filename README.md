...
![alt text](https://github.com/svenbuder/GALAH_DR3/tree/master/release_paper/figures/plot_parallax_quality_and_cmds.pdf "Astro- and photometric overview of the observed stars")
